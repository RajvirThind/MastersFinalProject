...
from BESSOptimisation.src.milp.milp_optimiser_day_ahead import BESS_Optimiser
from BESSOptimisation.src.rl.train_dqn import BESSEnv   
...
if __name__ == "__main__":
    ...
    # Pass the trained model and the normalisation statistics
    run_comparison(test_window, params, "models/bess_dqn_original_competitive.zip", "models/vec_normalize_dqn_original.pkl")