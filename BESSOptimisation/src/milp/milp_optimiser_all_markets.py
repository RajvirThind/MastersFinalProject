...
class BESS_Optimiser:
    ...
    def set_objective(self):
        ...
        # We penalise the 'expected' revenue to reflect that most bids are ignored
        ...
        # Penalises the battery for sitting in or moving through high/low SOC zones (<20% or >80%)
    ...
    def set_constraints(self):
        ...
        for t in self.time_steps:
            ...
            # When discharging, we pull 1/sqrt(RTE) from the battery to get 1 unit of power out.
    ...
    def plot_operation(self, results_df):
        ...
        #Market Power Allocation (Stacked)
    ...
    def plot_financial_appraisal(summary_df, battery_params):
        #Parameters & Assumptions (2026 Benchmarks)
