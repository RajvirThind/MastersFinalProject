...
from DayAheadMILP_optimiser import BESS_Optimiser #MILP
from dayahead_agent_v2 import BESSEnv   #RL
...
if __name__ == "__main__":
    ...
    run_comparison(test_window, params, "bess_ppo_lookahead_normalized.zip", "vec_normalize_ppo.pkl")