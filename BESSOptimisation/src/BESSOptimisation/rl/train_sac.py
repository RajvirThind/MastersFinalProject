...
from BESSOptimisation.src.BESSOptimisation.environments.dayahead_bess_env import BESSEnv
...
# Use a new name so it doesn't overwrite your old baseline
MODEL_NAME = "bess_sac_lookahead_normalized"
...
if os.path.exists(f"{MODEL_NAME}.zip"):
    ...
    # Initialize and apply timer callback
