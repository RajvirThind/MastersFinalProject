...
from BESSOptimisation.src.BESSOptimisation.environments.dayahead_bess_env import BESSEnv   #RL
from stable_baselines3 import SAC
from stable_baselines3.common.vec_env import DummyVecEnv, VecNormalize

# Updated function to accept the normalization file path
...
if __name__ == "__main__":
    ...
    # Pass the normalized model name and the vec_normalize.pkl file
    run_comparison(test_window, params, "bess_sac_lookahead_normalized.zip", "vec_normalize.pkl")